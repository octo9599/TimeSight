...
async function test() {
	...
	try {
		...
		print(
			(await axios.get(`${API}/gruppe/${group_id}/termin`, { params: { is_past_due: 1 } }))
				.data,
		)
		...
		print((await axios.get(`${API}/gruppe/${group_id}/beitritt_anfrage`)).data)
		...
		print((await axios.delete(`${API}/beitritt_anfrage/${anfrage_id}`)).data)
