...
async function createGroup() {
	...
	try {
		...
		try {
			...
			throw new Error(
				'Gruppe wurde erstellt, aber die Gruppen-ID konnte nicht ermittelt werden.',
			)
		}
		...
		try {
			...
			throw new Error(
				'Gruppe wurde erstellt, aber das Hinzufügen des Benutzers zur Gruppe ist fehlgeschlagen.',
			)
		}
	...
	<div class="add-group-form">
		...
		<form @submit.prevent="createGroup" class="group-form">
			...
			<div v-if="inviteCode" class="invite-code">
				...
				<small
					>Teile diesen Code mit deinen Freunden, damit sie der Gruppe beitreten
					können.</small
				>
			</div>
