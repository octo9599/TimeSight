...
<template>
	<form class="auth-card" @submit.prevent="loginSubmit">
		<div class="brand-row">
		...
		<button class="link-forgot" type="button" @click="$router.push('/forgot-password')">
			Passwort vergessen
		</button>
		...
		<div class="signup-row">
			...
			<button class="link-signup" type="button" @click="$router.push('/register')">
				Account erstellen
			</button>
		</div>
	</form>
